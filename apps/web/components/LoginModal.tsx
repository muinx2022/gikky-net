  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-900 rounded-xl max-w-sm w-full p-6 relative">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Đăng nhập</h2>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">Tiếp tục với Google</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">Tiếp tục với Facebook</span>
          </button>
        </div>
