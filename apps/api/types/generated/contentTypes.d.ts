...
export interface ApiCategoryActionCategoryAction
  extends Struct.CollectionTypeSchema {
  collectionName: 'category_actions';
  info: {
    description: 'User actions for categories (follow/moderator)';
    displayName: 'Category Action';
    pluralName: 'category-actions';
    singularName: 'category-action';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    actionType: Schema.Attribute.Enumeration<['follow', 'moderator']> &
      Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::category-action.category-action'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['active', 'pending', 'removed']> &
      Schema.Attribute.Required &
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hierarchical categories for posts';
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Comments on posts with support for nested replies';
    displayName: 'Comment';
    pluralName: 'comments';
  ...
  attributes: {
    ...
    post_actions: Schema.Attribute.Relation<
      'oneToMany',
      'api::post-action.post-action'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages for front community box and footer links';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ftType: Schema.Attribute.Enumeration<['front', 'footer']> &
      Schema.Attribute.Required &
...
export interface ApiPostActionPostAction extends Struct.CollectionTypeSchema {
  collectionName: 'post_actions';
  info: {
    description: 'Unified user actions for posts and comments (like/follow)';
    displayName: 'Post Action';
    pluralName: 'post-actions';
    singularName: 'post-action';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    post: Schema.Attribute.Relation<'manyToOne', 'api::post.post'>;
    publishedAt: Schema.Attribute.DateTime;
    targetType: Schema.Attribute.Enumeration<['post', 'comment']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
