---
name: gikky-tin-truoc-phien-vn
description: Bản tin gikky.net slot truoc-phien-vn — trước giờ mở cửa HOSE, 08:07 T2-T6
---

Nhiệm vụ: đăng bản tin slot `truoc-phien-vn` (tin trong nước trước giờ mở cửa) lên gikky.net bằng tài khoản bot.

**Toàn bộ hướng dẫn nằm trong file này — đọc nó TRƯỚC KHI làm bất cứ gì:**

    D:\Projects\gikky-net\scripts\tin-tuc\lich\truoc-phien-vn.md
...
- Script tự từ chối khi chạy NGOÀI khung giờ (trước 06:30 hoặc sau 09:00 giờ VN) và thoát mã `4`. **Đó là kết quả ĐÚNG, không phải sự cố.** Tuyệt đối không lách bằng `--ep`, `--som-nhat` hay `--han-chot`.
