 ...
 */
export const congKhaiMach = <ThrowOnError extends boolean = false>(options: Options<CongKhaiMachData, ThrowOnError>): RequestResult<CongKhaiMachResponses, CongKhaiMachErrors, ThrowOnError> => (options.client ?? client).post<CongKhaiMachResponses, CongKhaiMachErrors, ThrowOnError>({
    security: [{
            key: 'DangNhap',
            in: 'cookie',
            name: 'sessionid',
 ...
 */
export const tatBinhLuanMach = <ThrowOnError extends boolean = false>(options: Options<TatBinhLuanMachData, ThrowOnError>): RequestResult<TatBinhLuanMachResponses, TatBinhLuanMachErrors, ThrowOnError> => (options.client ?? client).post<TatBinhLuanMachResponses, TatBinhLuanMachErrors, ThrowOnError>({
    security: [{
            key: 'DangNhap',
            in: 'cookie',
            name: 'sessionid',
